...
//
    ...
    init(Data dictionary:[String: Any]){
        ...
        if let adescription = dictionary["description_bio"] as? String {
            description_bio = adescription
        }
...
//        }
    ...
    class func Populate(dictionary:[String: Any]) -> BioScreen {
        let obj = BioScreen(Data: dictionary)
        return obj
    }
    
    class func PopulateArray(array:[[String: Any]]) -> [BioScreen] {
        var result :[BioScreen] = []
        for item in array {
            let obj = BioScreen(Data: item)
            result.append(obj)
        }
        return result
    }
