...
class QiraatListingResponse: NSObject {
...
//        }
    ...
    class func Populate(dictionary:[String: Any]) -> QiraatListingResponse {
        let obj = QiraatListingResponse(Data: dictionary)
        return obj
    }
    
    class func PopulateArray(array:[[String: Any]]) -> [QiraatListingResponse] {
        var result :[QiraatListingResponse] = []
        for item in array {
            let obj = QiraatListingResponse(Data: item)
            result.append(obj)
        }
        return result
    }
